...
# AssociationTypeMismatchError is a custom error created specifically for this test. It is not a real erorr, only one we choose to raise given the specific instance. 